...
Status: frontend prototype, paused. The UI and data model are built; the backend is not implemented — the app currently runs on mock data. See Project status.
